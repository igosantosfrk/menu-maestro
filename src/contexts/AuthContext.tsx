...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const checkOnb = async () => {
      if (profile?.tenant_id) {
        const { data } = await supabase.from('tenants').select('onboarding_completed').eq('id', profile.tenant_id).single();
  ...
  return (
    <AuthContext.Provider value={{
      ...
      signIn, signUp, signOut, refreshProfile, onboardingCompleted
    }}>
      {children}
